...
对于这个公式的证明，只需要将 $\displaystyle \frac{\Delta \alpha}{\Delta s}$ 的极限化为 $\displaystyle \frac{d\alpha}{dt}\cdot \frac{dt}{ds}$ 即可。其中 $ds$ 是对弧长的微分，$\displaystyle \frac{ds}{dt} = \sqrt{\varphi'^2 + \psi'^2}$ 的证明需要曲线积分的知识。
